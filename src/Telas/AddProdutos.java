    ...
    private void SalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SalvarActionPerformed
        ...
        if(Nome.getText().isEmpty() && Preco.getText().isEmpty() && Quant.getText().isEmpty()){
            ...
            try {
                ...
                JOptionPane.showMessageDialog(null, "Cadastrou com sucesso o produto");
            } catch (SQLException ex) {
                Logger.getLogger(AddProdutos.class.getName()).log(Level.SEVERE, null, ex);
            }
            Cod.setText("");
            Nome.setText("");
            Preco.setText("");
            Quant.setText("");
            Litros.getSelectedItem();
        }
